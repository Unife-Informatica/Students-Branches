...
# per evitare eventuali messaggi di errore nel caso vi
# siano piu file con estensione .txt nel direttorio corrente,
# si puo' usare `ls *.txt 2>/dev/null` al posto di *.txt
