...
print(f"Tipo di algorithm_name: {type(algorithm_name)} | dtype: {algorithm_name.dtype}\n")
...
print(f"Prodotto puntuale (v_a * v_b): {pointwise_product} | Shape: {pointwise_product.shape}\n")
