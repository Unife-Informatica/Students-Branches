...
try:
    assert grid_nodes.dtype == np.float64, "Errore: L'array risultante deve essere di tipo float64."
    assert np.allclose(grid_nodes, [15.0, 15.0, 22.5, 30.0]), "Errore: I valori nodali o l'applicazione del lower_bound sono errati."
    print("Script 1: Validazione superata. Gestione dei tipi e mascheramento corretti.\n")
