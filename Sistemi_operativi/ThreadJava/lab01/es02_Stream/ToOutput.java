  ...
  public void run() {
    try {
      ...
      while ((nread = pis.read(buffer)) > 0) {
        ...
        // Errato, in quanto non è detto che il buffer sia stato utilizzato
        // completamente
        // System.out.println("ToOutput: " + new String(buffer,
        // Charset.forName("UTF-8")));

        // Qui per evitare di stampare l'intero buffer posso:
        // 1) selezionare la porzione del buffer corrispondendete ai byte effettivamente
        // letti,
        ...
        // utilizzando Arrays.copyOfRange che permette di copiare una specifica porzione
        // di array
